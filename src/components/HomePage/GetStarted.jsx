...
import getstarted from '../../../public/images/image(1).png'
import Accrodians from './Accrodians/Accrodians'
const GetStarted = () => {
  return (
    <section id='getstarted' className='bg-white'>
        <Container>
            <div className='md:grid grid-cols-2 justify-between gap-8 py-5 items-center min-h-[50vh]'>
                ...
                <div className='col-span-1 flex md:justify-end justify-center'>
                  <Image src={getstarted} alt='getstarted' style={{width:'60%', minHeight:'50vh' }}  />
                </div>
            </div>
        </Container>
    </section>
