  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-6">
          <label
            htmlFor="azupayclidasumailaddforlog"
            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
          >
            Azupay client dashboard user email address for login *
          </label>
          <input
            onChange={handleChange}
            name="azupayclidasumailaddforlog"
            value={formData.azupayclidasumailaddforlog}
            type="email"
            id="azupayclidasumailaddforlog"
          ...
          <small className="text-[10px]">
            If provided, this email address will receive a message with a
            temporary password to sign into the dashboard as an Admin user.
          </small>
        </div>

        <div className="mb-6">
          <label
            htmlFor="trolforthedashuser"
            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
          >
            The role for the dashboard user*
          </label>
          <input
            onChange={handleChange}
            name="trolforthedashuser"
            value={formData.trolforthedashuser}
            type="text"
            id="trolforthedashuser"
            className="bg-gray-50 border-gray-300 text-gray-900 block w-full p-2.5 text-sm rounded-lg outline-none border-2 focus:border-primary"
            placeholder="admin , support , finance"
            required
          />
          <small className="text-[10px] leading-[1rem]">
            If none is supplied it will be deafulted to &apos;Admin&apos;.
            Applicable roles are &apos;Admin&apos;, &apos;Finance admin&apos;
