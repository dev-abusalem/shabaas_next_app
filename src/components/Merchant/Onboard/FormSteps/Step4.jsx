  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-6">
          <label
            htmlFor="sbsbacnumpayidsetacc"
            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
          >
            Settlement BSB & account number or PayID of settlement account*
          </label>
          <input
            onChange={handleChange}
            name="sbsbacnumpayidsetacc"
            value={formData.sbsbacnumpayidsetacc}
            type="number"
            id="sbsbacnumpayidsetacc"
            ...
            placeholder="343-434-343 123456"
            required
          />
          <small className="text-[10px]">
            The BSB & account number or PayID of the account used to sweep
            collected funds for this client.
          </small>
        </div>

        <div className="mb-6">
          <label
            htmlFor="payiddomsubmerchant"
            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
          >
            PayID Domain of the Sub-merchant*
          </label>
          <input
            onChange={handleChange}
            name="payiddomsubmerchant"
            value={formData.payiddomsubmerchant}
            type="text"
            id="payiddomsubmerchant"
            className="bg-gray-50 border-gray-300 text-gray-900 block w-full p-2.5 text-sm rounded-lg outline-none border-2 focus:border-primary"
            placeholder="google.com , google.com.au , facebook.com"
            required
          />
          <small className="text-[10px] leading-[1rem]">
            A list of the domain names that can be used for PaylDs for this
            sub-merchant. Optionally use merchantName to control the PayID
            description prefix
          </small>
        </div>
